...
const CGFloat GCDiscreetNotificationViewBorderSize = 20;
const CGFloat GCDiscreetNotificationViewPadding = 10;
const CGFloat GCDiscreetNotificationViewHeight = 14;
const CGFloat GCDiscreetNotificationViewHeightOffset = 57;
...
- (void)dealloc
{
    ...
    printf("dealloc- GCDiscreetNotificationView\n");
...
- (void) layoutSubviews
{
    ...
    CGFloat maxLabelWidth = frameWidth - indicatorWidth * withActivity - baseWidth;
...
//    CGFloat activityIndicatorWidth = (self.activityIndicator != nil) ? 10 : 0;


	CGRect activityBounds = CGRectMake(activityIndicatorWidth , -6, activityIndicatorWidth , activityIndicatorWidth);
    self.activityIndicator.frame = activityBounds;
    ...
    if (self.activityIndicator == nil)
        self.label.frame = CGRectMake(GCDiscreetNotificationViewBorderSize, -4.0, textSizeWidth, GCDiscreetNotificationViewHeight+6.0);
    else
    {
        ...
        //self.activityIndicator.frame = CGRectMake(0, -5, self.activityIndicator.frame.size.width, self.activityIndicator.frame.size.height);
        
        self.label.frame = CGRectMake(GCDiscreetNotificationViewBorderSize + GCDiscreetNotificationViewPadding + self.activityIndicator.frame.size.width, -4, textSizeWidth, GCDiscreetNotificationViewHeight+6.0);
    }
...
- (void) drawRect:(CGRect)rect
{
    ...
    CGContextSetFillColorWithColor(context, [UIColor colorWithRed:0.0 green:0.0 blue:0.0 alpha:0.8].CGColor); //[UIColor colorWithWhite:0.0 alpha:0.5].CGColor);
...
- (CGPoint) showingCenter
{
    ...
    {
       ycalc = GCDiscreetNotificationViewHeight + GCDiscreetNotificationViewHeightOffset;
    }
    else
    {
        ycalc = GCDiscreetNotificationViewHeight + GCDiscreetNotificationViewHeightOffset-20;
    }
    
    
    if (self.presentationMode == GCDiscreetNotificationViewPresentationModeTop) y = ycalc; // 15+35; // 15;
...
{
    CGFloat y = 0;
    if (self.presentationMode == GCDiscreetNotificationViewPresentationModeTop) y = GCDiscreetNotificationViewHeightOffset; //- GCDiscreetNotificationViewHeight; //-15;
